 ...
 * --------------------------------------------------------------------------
 */
function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}var Util=function(a){
...
/**
   ...
   * ------------------------------------------------------------------------
   */
return a(document).on(k.CLICK_DATA_API,n.DATA_TOGGLE,function(b){b.preventDefault();var c=o._getTargetFromElement(this),e=a(c).data(d),f=e?"toggle":a(this).data();o._jQueryInterface.call(a(c),f)}),a.fn[b]=o._jQueryInterface,a.fn[b].Constructor=o,a.fn[b].noConflict=function(){return a.fn[b]=g,o._jQueryInterface},o}(jQuery);/*!
 ...
 */
a.extend("pickadate",c)}),$(".collapse").on("show.bs.collapse",function(a){var b=$(this).parent().find(".user-left .fa");b.removeClass("fa-caret-right").addClass("fa-caret-down")}).on("hide.bs.collapse",function(){var a=$(this).parent().find(".user-left .fa");a.removeClass("fa-caret-down").addClass("fa-caret-right")}),/* pickadate
/* https://github.com/amsul/pickadate.js
----------------------------------------------------------------------------
----------------------------------------------------------------------------
---------------------------------------------------------------------------*/
$.fn.userDatePicker=function(){var a=$(this),b=$(this).parent().children(".input-group-addon");$(this).attr("id")+"_picker";a.pickadate({
//format: 'mmmm dd, yyyy',
format:"mm/dd/yyyy",today:'<i class="fa fa-crosshairs" aria-hidden="true"></i>',clear:"",close:'<i class="fa fa-times" aria-hidden="true"></i>',formatSubmit:"yyyy-mm-dd",hiddenName:!0,onStart:function(){
//var date = new Date();
var a=new Date(2016,11,31);this.set("select",[a.getFullYear(),a.getMonth(),a.getDate()])},onClose:function(b){a.text(this.get()),$(".cal-wrapper").removeClass("cal-hover"),$(document.activeElement).blur()}}),picker_open_close=$(this).pickadate("picker"),b.on("click",function(a){picker_open_close.get("open")?picker_open_close.close():picker_open_close.open(),a.stopPropagation()}).on("mousedown",function(a){a.preventDefault()}),a.text(picker_open_close.get())},$('[id$="_date"]').each(function(a){var b=$(this),c=b.parent().children(".input-group-addon").children(".fa-calendar-o");b.userDatePicker(),b.add(c).on("mouseover mouseout",function(){b.add(c).toggleClass("cal-hover")})});