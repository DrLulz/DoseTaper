...
$("#datepicker-addon .fa-calendar-o, #input_date").on("mouseover mouseout",function(){$("#datepicker-addon .fa-calendar-o, #input_date").toggleClass("cal-hover")}),/* iCheck
...
$("[id$=_form]").on("keydown",".twitter-typeahead #taper_med",function(a){13!=a.which&&9!=a.which||(a.preventDefault(),$(".tt-selectable").first().click())}),/* headroom
/* https://github.com/WickyNilliams/headroom.js
----------------------------------------------------------------------------
----------------------------------------------------------------------------
---------------------------------------------------------------------------*/
$("nav").headroom({tolerance:5,offset:205,classes:{initial:"animated",pinned:"slideDown",unpinned:"slideUp"}}),/*--------------------------------------------------------------------------
  --------------------------------------------------------------------------
  *
...
return 9==b&&c==d?(a.preventDefault(),void $("#add").trigger("click")):13==b?(a.preventDefault(),void $(this).blur()):void 0}}),$("[id$=_dose], [id$=_days], [id$=_mg], [id$=_time]").each(function(a){var b=$(this),c=b[0].id;b.onFocus(),b.onBlur(),~c.indexOf("dose")?b.doseInput():~c.indexOf("days")?b.daysInput():~c.indexOf("mg")?(b.doseInput(),b.linearInput()):~c.indexOf("time")&&(b.daysInput(),b.linearInput())}),$("#add, #ladd").click(function(a){$(this).closest("form").find(":input").slice(-1).blur(),"ladd"==a.target.id&&($("#ladd").addClass("phase-empty animated slideOutRight"),$("#pl #calc").removeClass("slideInRight").addClass("slideOutRight"));
...
newControls(e),$("html, body").animate({scrollTop:e.offset().top},500)}),$("#del, #ldel").click(function(a){if("ldel"==a.target.id?($("#pl #calc").removeClass("slideOutRight").addClass("slideInRight"),$("#ladd").addClass("slideInRight").removeClass("phase-empty slideOutRight")):$("#p2").length||($("#ldel").removeClass("slideInRight").addClass("slideOutRight").one(animation_end,function(){$(this).addClass("phase-empty").removeClass("phase-del animated slideInRight")}),$("#ladd").addClass("slideInRight").removeClass("phase-empty slideOutRight"),$("#pl #calc").removeClass("slideOutRight").addClass("slideInRight")),2!=$(".phase").length){var b=$(".phase").slice(2).last(),c=$(".non-linear .phase-add-delete"),d="slideInRight",e="slideOutRight";c.removeClass(d).addClass(e).one(animation_end,function(){$(this).removeClass(e)}),b.removeClass("slideInRight").addClass("slideOutRight").one(animation_end,function(){$(this).slideToggle("fast","linear",function(){b.detach()}),c.addClass(d).appendTo(b.prev());var a=$(this).closest("form").find(":input");a.slice(-4,-3).focus()})}});
...
// Table bordered
$("#table-bordered").change(function(){var b=$(this).val();a.removeClass("table-bordered").addClass(b)}),
// Table striped
$("#table-striped").change(function(){var b=$(this).val();a.removeClass("table-striped").addClass(b)}),
// Table hover
$("#table-hover").change(function(){var b=$(this).val();a.removeClass("table-hover").addClass(b)}),
// Table color
$("#table-color").change(function(){var b=$(this).val();a.removeClass(/^table-mc-/).addClass(b)})}),
// jQuery’s hasClass and removeClass on steroids
// by Nikita Vasilyev
// https://github.com/NV/jquery-regexp-classes
function(a){jQuery.fn.removeClass=function(b){if(b&&"function"==typeof b.test)for(var c=0,d=this.length;c<d;c++){var e=this[c];if(1===e.nodeType&&e.className){for(var f=e.className.split(/\s+/),g=f.length;g--;)b.test(f[g])&&f.splice(g,1);e.className=jQuery.trim(f.join(" "))}}else a.call(this,b);return this}}(jQuery.fn.removeClass);