...
var h=$("<div/>",{"class":"col-xs-7 pull-xs-3 col-sm-8 pull-sm-2 col-md-9 pull-md-1 phase-params"}),i=$("<div/>",{"class":"row"}),j=$("<div/>",{"class":"col-md-6 dose-param"}),k=$("<label/>",{"class":"param-label","for":c+"_dose",html:"Dose"}),l=$("<input/>",{"class":"param-input",type:"tel",id:c+"_dose",name:c+"_dose"});k.appendTo(j),l.appendTo(j);
// days
