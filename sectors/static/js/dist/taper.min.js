...
//n.show()
mobile&&console.log("mobile"),$("#results").length&&console.log("results length"),mobile&&$("#results").length&&(console.log("remove class"),$("table").removeClass("table-hover")),console.log("here");