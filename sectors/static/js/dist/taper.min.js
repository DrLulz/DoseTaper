...
// 2 rows
if(width()<1156){var a=$("tr.row-0").children("td").slice(0,3),b=$("tr.row-0").children("td").slice(3,6);$(".size-param table").append($("<tr/>",{"class":"row-1",html:a})),$(".size-param table").append($("<tr/>",{"class":"row-2",html:b})),$(".row-0").remove()}$(window).resize(function(){
//var width = $(window).width();
var a=$(".size-param table"),b=$(".row-0"),c=$(".row-1"),d=$(".row-2");
// one row
if(width()>1155)b.length||(c.append(d.children()).removeClass("row-1").addClass("row-0"),d.remove());else if(b.length){var e=$("tr.row-0").children("td").slice(0,3),f=$("tr.row-0").children("td").slice(3,6);a.append($("<tr/>",{"class":"row-1",html:e})),a.append($("<tr/>",{"class":"row-2",html:f})),b.remove()}}),width()<lg&&$(".sup-size-wrapper").removeClass("v-align"),width()<md&&$(".sup-med-wrapper").removeClass("v-align"),$(window).resize(function(){width()<md?$(".sup-med-wrapper").removeClass("v-align"):$(".sup-med-wrapper").addClass("v-align"),width()<lg?$(".sup-size-wrapper").removeClass("v-align"):$(".sup-size-wrapper").addClass("v-align")})}// initialControls()
/* Q.O.D. behavior
---------------------------------------------------------------------------*/
...
//function onOpened($e) {}
function onSelected(a,b){
//console.log('rx_name', rx_name)
//$('.meds').not('#' + rx_name).hide();
//$('#' + rx_name).show();
a.target.blur()}function onAutocompleted(a,b){
//console.log('rx_name', rx_name)
//$('.meds').not('#' + rx_name).hide();
//$('#' + rx_name).show();
a.target.blur()}/* f(x)
...
---------------------------------------------------------------------------*/
$.fn.initialControls=function(){var a=$("<div/>",{"class":"phase-add-delete animated slideInRight"}).append($("<div>",{id:"del","class":"phase-del"})).append($("<div>",{id:"add","class":"phase-add"})).append($("<div>",{id:"calc","class":"taper-calc"}));this.append(a),$(".phase-add, .phase-del, .taper-calc").on("mouseover touchstart",function(){$(this).filter(":not(:animated)").animate({width:"100%"},"fast")}).on("mouseout touchend",function(){$(this).animate({width:"80%"},"fast")})},/* typeahead
---------------------------------------------------------------------------*/
