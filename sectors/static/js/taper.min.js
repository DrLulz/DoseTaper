...
$("input.autogrow").autoGrowInput({minWidth:421,comfortZone:20}),$(window).resize(function(){$("input.autogrow").autoGrowInput({minWidth:421,comfortZone:20})}),/*     if (mobile) {
        var deviceAgent = navigator.userAgent.toLowerCase();
        var iOS = deviceAgent.match(/(iPad|iPhone|iPod)/i);
        if (iOS) {
            console.log('iOS');
...
console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth),console.log("testerWidth",g),console.log("o.comfortZone",a.comfortZone),console.log("minWidth",b),console.log("testerWidth + o.comfortZone",g+a.comfortZone),console.log("(testerWidth + o.comfortZone) >= minWidth",g+a.comfortZone>=b),console.log("newWidth",h),
//console.log('o.maxWidth', o.maxWidth);
console.log("currentWidth",i),console.log(""),console.log("testSubject.width",e.width()),console.log("testSubject.fontSize",e.css("fontSize")),console.log("testSubject.fontFamily",e.css("fontFamily")),console.log("testSubject.fontWeight",e.css("fontWeight")),console.log("testSubject.letterSpacing",e.css("letterSpacing")),console.log("testSubject.whiteSpace",e.css("whiteSpace"))}};if(e.insertAfter(d),
//$(this).bind('keyup keydown blur update', check);
//$(this).bind('keyup load blur update change', check).bind('keydown', function() {
//    setTimeout(check);
//});
$(this).bind("change",f),f(),mobile){var g=navigator.userAgent.toLowerCase(),h=g.match(/(iPad|iPhone|iPod)/i);h&&console.log("iOS")}}),this};