...
$("input.autogrow").autoGrowInput({minWidth:30,comfortZone:20}),$(window).resize(function(){$("input.autogrow").autoGrowInput({minWidth:30,comfortZone:20})}),mobile){var a=navigator.userAgent.toLowerCase(),b=a.match(/(iPad|iPhone|iPod)/i);b&&console.log("iOS")}
