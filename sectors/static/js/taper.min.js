...
// Data API //
//////////////
a("[data-headroom]").each(function(){var b=a(this);b.headroom(b.data())}))}(window.Zepto||window.jQuery),$(document).ready(function(){$("#nl_taper form").floatlabels({style:1}),/* datepicker (pickadate)
    ---------------------------------------------------------------------------*/
date_picker(),mobile?($(".picker__frame").css({bottom:"0","margin-bottom":"0",top:"auto"}),$(".picker__box").css({"border-radius":"0","border-bottom-width":"0"})):$(".picker__frame").css({top:"15%"}),
...
checkboxes(),checkbox_resize(),/* headroom js
    ---------------------------------------------------------------------------*/
$("nav").headroom({tolerance:5,offset:205,classes:{initial:"animated",pinned:"slideDown",unpinned:"slideUp"}}),$(".phase").last().taperControls(),paramsSize(),/* 
    ---------------------------------------------------------------------------*/
$(".phase-qod").on("click",function(a){$(this).toggleClass("active");var b=0==$(this).children().val()?"1":"0";$(this).children().val(b),a.preventDefault()})}),$.fn.reconstitute=function(){/* initialize qod
    --------------------------------------------------*/
this.find("").on("click",function(){alert(1)})},$.fn.taperControls=function(){
// var controls = $('<div/>', { class: 'phase-add-delete v-align' }).
var a=$("<div/>",{"class":"phase-add-delete"}).append($("<div>",{id:"del","class":"phase-del"})).append($("<div>",{id:"add","class":"phase-add"})).append($("<div>",{id:"calc","class":"taper-calc"}));this.append(a),
//this.append($('<div/>', {class: 'phase-add-delete v-align', html: '<div class="phase-del"></div><div class="phase-add"></div>'}));
$(".phase-add, .phase-del, .taper-calc").on("mouseover",function(){$(this).filter(":not(:animated)").animate({width:"100%"},"fast")}).on("mouseout",function(){$(this).animate({width:"80%"},"fast")})},$(function(){$("#add").click(function(){console.log("hello");var a=1;$.each($(".phase"),function(){parseInt($(this).data("id"))>a&&(a=parseInt($(this).data("id")))}),a++,console.log(a)})});