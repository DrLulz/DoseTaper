...
// 2 rows
if($(window).width()<1156&&$(window).width()>979||$(window).width()<733){var a=$("tr.row-0").children("td").slice(0,3),b=$("tr.row-0").children("td").slice(3,6);$(".size-param table").append($("<tr/>",{"class":"row-1",html:a})),$(".size-param table").append($("<tr/>",{"class":"row-2",html:b})),$(".row-0").remove()}$(window).resize(function(){var a=$(window).width(),b=$(".size-param table"),c=$(".row-0"),d=$(".row-1"),e=$(".row-2");
// one row
