...
//maxWidth: 1000,
if(mobile){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iPad|iPhone|iPod)/i);if(c)if(verge.viewportW()>verge.viewportH())var d=0;else var d=1}return a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a),this.filter("input:text").each(function(){var b=a.minWidth||$(this).width(),c="",e=$(this),f=$("<tester/>").attr("id","tester").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:e.css("fontSize"),fontFamily:e.css("fontFamily"),fontWeight:e.css("fontWeight"),letterSpacing:e.css("letterSpacing"),whiteSpace:"nowrap"}),g=function(){if(c!==(c=e.val())){
// Enter new content into testSubject
var g=c.replace(/&/g,"&amp;").replace(/\s/g," ").replace(/</g,"&lt;").replace(/>/g,"&gt;");f.html(g);
// Calculate new width + whether to change
//var testerWidth = testSubject.width();
var h=$("tester").width(),i=h+a.comfortZone>=b?h+a.comfortZone:b,j=e.width(),k=i<j&&i>=b||i>b&&i<a.maxWidth;
// Animate width
k&&(localStorage.getItem("initial_view")?(console.log("not first time here"),
//localStorage.removeItem('initial_view');
e.width(i)):(console.log("first time here"),
//localStorage.setItem('initial_view', 'true');
d?e.width(j-verge.viewportW()+a.comfortZone):e.width(i))),console.log("viewportW()",verge.viewportW()),h===document.getElementById("tester").offsetWidth?console.log("testerWidth",h):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",h),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
//console.log('o.comfortZone', o.comfortZone);
//console.log('minWidth', minWidth);
console.log("testerWidth + o.comfortZone = newWidth",h+a.comfortZone),
//console.log('(testerWidth + o.comfortZone) >= minWidth', ((testerWidth + o.comfortZone) >= minWidth))
//console.log('newWidth', newWidth);
//console.log('o.maxWidth', o.maxWidth);
console.log("currentWidth",j),console.log("")}};f.insertAfter(e),
//$(this).bind('keyup keydown blur update', check);
//$(this).bind('keyup load blur update change', check).bind('keydown', function() {
//    setTimeout(check);
//});
$(this).bind("change",g),g(),$(window).load(g())}),this},/* $('<div/>', {
    id: someID,
    className: 'foobar',
    html: content
}); */
...
localStorage.removeItem("initial_view")}),$(window).load(function(){localStorage.setItem("initial_view","true")});