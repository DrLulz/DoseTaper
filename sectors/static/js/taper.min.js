...
// Animate width
j&&d.width(h),console.log("viewportW()",verge.viewportW()),
//console.log('input', input)
//console.log('testSubject', testSubject)
console.log("testerWidth",g),console.log("o.comfortZone",a.comfortZone),console.log("minWidth",b),console.log("testerWidth + o.comfortZone",g+a.comfortZone),console.log("(testerWidth + o.comfortZone) >= minWidth",g+a.comfortZone>=b),console.log("newWidth",h),console.log(""),console.log("o.maxWidth",a.maxWidth),console.log("currentWidth",i),console.log("")}};if(e.insertAfter(d),
//$(this).bind('keyup keydown blur update', check);
//$(this).bind('keyup load blur update change', check).bind('keydown', function() {
//    setTimeout(check);
//});
$(this).bind("change",f),f(),mobile){var g=navigator.userAgent.toLowerCase(),h=g.match(/(iPad|iPhone|iPod)/i);h&&(console.log("iOS"),$("tester").remove(),e.insertAfter(d),
//window.dispatchEvent(new Event('resize'));
f())}}),this};