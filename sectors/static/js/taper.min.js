...
var g=$("tester").width();$("#tester").css({width:g});
...
var h=g+a.comfortZone>=b?g+a.comfortZone:b,i=d.width(),j=h<i&&h>=b||h>b&&h<a.maxWidth;
// Animate width
j&&d.width(h),
...
//    setTimeout(check);
//});
$(this).bind("change",f),f(),$(window).load(f()),mobile){var g=navigator.userAgent.toLowerCase(),h=g.match(/(iPad|iPhone|iPod)/i);h&&console.log("iOS")}}),this};