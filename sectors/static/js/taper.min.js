...
mobile?($(".picker__frame").css({bottom:"0","margin-bottom":"0",top:"auto"}),$(".picker__box").css({"border-radius":"0","border-bottom-width":"0"})):$(".picker__frame").css({top:"15%"}),$("input").iCheck({checkboxClass:"icheckbox_flat-grey",radioClass:"iradio_flat-grey",increaseArea:"20%"}),
...
$(".date-wrapper").mouseover(function(){$(this).addClass("date-hover")}).mouseout(function(){$(this).removeClass("date-hover")})}),
//(function($){
