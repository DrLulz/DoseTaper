...
//maxWidth: 1000,
if(mobile){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iPad|iPhone|iPod)/i);if(c)if(console.log("iOS"),verge.viewportW()>verge.viewportH())var d="landscape";else var d="portrait"}return console.log("orientation",d),"portrait"==d?(console.log("mobile portrait"),a=$.extend({maxWidth:185,minWidth:0,comfortZone:70},a)):a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a),this.filter("input:text").each(function(){var b=a.minWidth||$(this).width(),c="",d=$(this),e=$("<tester/>").attr("id","tester").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:d.css("fontSize"),fontFamily:d.css("fontFamily"),fontWeight:d.css("fontWeight"),letterSpacing:d.css("letterSpacing"),whiteSpace:"nowrap"}),f=function(){if(c!==(c=d.val())){
