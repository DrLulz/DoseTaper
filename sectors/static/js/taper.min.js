...
console.log("js testerWidth",document.getElementById("tester").offsetWidth),console.log("testerWidth",g),
...
//    setTimeout(check);
//});
$(this).bind("change",f),f(),mobile){var g=navigator.userAgent.toLowerCase(),h=g.match(/(iPad|iPhone|iPod)/i);h&&console.log("iOS")}}),this},// autoGrowInput()
