 ...
 */
/** global: Option */
function date_picker(){var a=function(){$("#input_date").text(d.get())},b=$(".input-group-addon"),c=$("#input_date").pickadate({format:"mmmm dd, yyyy",today:'<i class="fa fa-crosshairs" aria-hidden="true"></i>',clear:"",close:'<i class="fa fa-times" aria-hidden="true"></i>',
//containerHidden: '#hidden_input_date',
onStart:function(){var a=new Date;this.set("select",[a.getFullYear(),a.getMonth(),a.getDate()])},onClose:function(){a(),$(".date-wrapper").removeClass("date-hover")}}),d=c.pickadate("picker");b.on("click",function(a){d.get("open")?d.close():d.open(),a.stopPropagation()}).on("mousedown",function(a){a.preventDefault()}),console.log(d.get()),a()}// autoGrowInput()
