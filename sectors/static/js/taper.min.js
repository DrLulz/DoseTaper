...
// Animate width
j&&(console.log("WIDTH CHANGED"),d.width(h)),
//console.log('viewportW()', verge.viewportW());
g===document.getElementById("tester").offsetWidth?console.log("testerWidth",g):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",g),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
