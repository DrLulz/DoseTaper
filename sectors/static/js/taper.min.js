...
e.width(i)):(console.log("first time here"),localStorage.setItem("initial_view","true"),d?e.width(j-verge.viewportW()+a.comfortZone):e.width(i))),console.log("viewportW()",verge.viewportW()),h===document.getElementById("tester").offsetWidth?console.log("testerWidth",h):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",h),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
