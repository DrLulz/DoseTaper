...
/* floating labels
---------------------------------------------------------------------------*/
function doseParam(){$(".dose-param").floatlabels({customEvent:null,customLabel:null,exclude:".no-label",inputRegex:/email|number|password|search|tel|text|url/,prioritize:"label",requiredClass:"required",style:1,transform:"input, select, textarea"})}function daysParam(){$(".days-param").floatlabels({
...
// Data API //
//////////////
a("[data-headroom]").each(function(){var b=a(this);b.headroom(b.data())}))}(window.Zepto||window.jQuery),/* f(x)
---------------------------------------------------------------------------*/
$.fn.reconstitute=function(){},doseParam(),daysParam(),// datepicker()
datePicker(),
