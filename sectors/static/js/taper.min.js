...
$("input.autogrow").autoGrowInput({minWidth:30,comfortZone:20}),$(window).resize(function(){$("input.autogrow").autoGrowInput({minWidth:30,comfortZone:20})}),mobile){var a=navigator.userAgent.toLowerCase(),b=a.match(/(iPad|iPhone|iPod)/i);b&&(console.log("iOS"),window.dispatchEvent(new Event("resize")))}
...
console.log("testerWidth",g),console.log("newWidth",h),console.log("minWidth",b),console.log("o.maxWidth",a.maxWidth),console.log("currentWidth",i)}};e.insertAfter(d),
