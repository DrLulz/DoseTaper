...
checkboxes(),checkbox_resize(),/* headroom js
    ---------------------------------------------------------------------------*/
$("nav").headroom({tolerance:5,offset:205,classes:{initial:"animated",pinned:"slideDown",unpinned:"slideUp"}}),$(".phase").last().taperControls(),$(".phase").each(function(a,b){$(b).qodControls(a)}),paramsSize()}),$.fn.qodControls=function(a){var b=a+1,c=$("<input/>",{"class":"checkbox qod",id:"qod_"+b,type:"checkbox",name:"qod_"+b}),d=$("<label/>",{"for":"qod_"+b,unselectable:"on",html:"Q.O.D."}),e=$("<div/>",{"class":"phase-qod-wrapper"}).append($("<div>",{"class":"phase-qod"}).append(c).append(d));this.append(e)},$.fn.taperControls=function(){
// var controls = $('<div/>', { class: 'phase-add-delete v-align' }).
var a=$("<div/>",{"class":"phase-add-delete"}).append($("<div>",{"class":"phase-del"})).append($("<div>",{"class":"phase-add"})).append($("<div>",{"class":"taper-calc"}));this.append(a),
//this.append($('<div/>', {class: 'phase-add-delete v-align', html: '<div class="phase-del"></div><div class="phase-add"></div>'}));
$(".phase-add, .phase-del, .taper-calc").on("mouseover",function(){$(this).filter(":not(:animated)").animate({width:"100%"},"fast")}).on("mouseout",function(){$(this).animate({width:"80%"},"fast")})};