...
//maxWidth: 1000,
if(mobile){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iPad|iPhone|iPod)/i);if(c)if(console.log("iOS"),verge.viewportW()>verge.viewportH())var d="landscape";else var d="portrait"}return console.log("orientation",d),a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a),this.filter("input:text").each(function(){var b=a.minWidth||$(this).width(),c="",e=$(this),f=$("<tester/>").attr("id","tester").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:e.css("fontSize"),fontFamily:e.css("fontFamily"),fontWeight:e.css("fontWeight"),letterSpacing:e.css("letterSpacing"),whiteSpace:"nowrap"}),g=function(){if(c!==(c=e.val())){
...
// Animate width
k&&(console.log("WIDTH CHANGED"),e.width(i),d&&e.width(j-verge.viewportW()+a.comfortZone)),console.log("viewportW()",verge.viewportW()),h===document.getElementById("tester").offsetWidth?console.log("testerWidth",h):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",h),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
