...
//maxWidth: 1000,
if(mobile){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iPad|iPhone|iPod)/i);if(c)if(verge.viewportW()>verge.viewportH());else;}return a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a),this.filter("input:text").each(function(){var b=a.minWidth||$(this).width(),c="",d=$(this),e=$("<tester/>").attr("id","tester").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:d.css("fontSize"),fontFamily:d.css("fontFamily"),fontWeight:d.css("fontWeight"),letterSpacing:d.css("letterSpacing"),whiteSpace:"nowrap"}),f=function(){if(c!==(c=d.val())){
...
// Animate width
j&&d.width(h),console.log("viewportW()",verge.viewportW()),g===document.getElementById("tester").offsetWidth?console.log("testerWidth",g):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",g),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
...
console.log("currentWidth",i),console.log("")}};e.insertAfter(d),
//$(this).bind('keyup keydown blur update', check);
//$(this).bind('keyup load blur update change', check).bind('keydown', function() {
//    setTimeout(check);
//});
$(this).bind("change",f),f(),$(window).load(f())}),this},/* $('<div/>', {
    id: someID,
    className: 'foobar',
    html: content
}); */
