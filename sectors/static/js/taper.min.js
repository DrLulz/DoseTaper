...
// Animate width
k&&(e.width(i),console.log("portrait",d),console.log("initial_view",localStorage.getItem("initial_view")),localStorage.getItem("initial_view")?
//console.log('not first time here')
//localStorage.removeItem('initial_view');
e.width(i):(
//console.log('first time here')
//localStorage.setItem('initial_view', 'true');
1==d?e.width(j-verge.viewportW()+a.comfortZone):e.width(i),localStorage.setItem("initial_view","true")))}};f.insertAfter(e),
...
localStorage.removeItem("initial_view")}),$(window).load(function(){localStorage.removeItem("initial_view")});