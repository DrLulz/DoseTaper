...
// Animate width
if(k){var l=localStorage.getItem("initial_view");console.log("initial_view",l),l?(console.log("initial_view = 1"),d?e.width(j-verge.viewportW()+a.comfortZone):e.width(i)):(console.log("initial_view = 0"),localStorage.setItem("initial","1"),e.width(i))}console.log("viewportW()",verge.viewportW()),h===document.getElementById("tester").offsetWidth?console.log("testerWidth",h):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",h),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
