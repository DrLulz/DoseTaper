...
// Animate width
j&&d.width(h),console.log("input",d),console.log("isValidWidthChange",j),console.log("testerWidth",g),console.log("newWidth",h),console.log("input.width()",i)}};e.insertAfter(d),
