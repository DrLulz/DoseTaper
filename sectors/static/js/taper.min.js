...
// Data API //
//////////////
a("[data-headroom]").each(function(){var b=a(this);b.headroom(b.data())}))}(window.Zepto||window.jQuery),$(document).ready(function(){$("form#nl_taper").floatlabels({style:1}),/* datepicker (pickadate)
    ---------------------------------------------------------------------------*/
...
checkboxes(),checkbox_resize(),/* headroom js
    ---------------------------------------------------------------------------*/
$("nav").headroom({tolerance:5,offset:205,classes:{initial:"animated",pinned:"slideDown",unpinned:"slideUp"}}),$(".phase").last().addDelete()}),$.fn.addDelete=function(){this.append($("<div/>",{"class":"phase-add-delete v-align",html:'<div class="phase-del"></div><div class="phase-add"></div>'})),$(".phase-add, .phase-del").on("mouseover",function(){$(this).filter(":not(:animated)").animate({width:"100%"},"fast")}).on("mouseout",function(){$(this).animate({width:"80%"},"fast")})};