 ...
 */
/** global: Option */
function date_picker(){var a=$(".input-group-addon"),b=$("#input_date").pickadate({format:"mmmm dd, yyyy",today:'<i class="fa fa-crosshairs" aria-hidden="true"></i>',clear:"",close:'<i class="fa fa-times" aria-hidden="true"></i>',onStart:function(){var a=new Date;this.set("select",[a.getFullYear(),a.getMonth(),a.getDate()])},onClose:function(){$(".date-wrapper").removeClass("date-hover")}}),c=b.pickadate("picker");a.on("click",function(a){c.get("open")?c.close():c.open(),a.stopPropagation()}).on("mousedown",function(a){a.preventDefault()})}// autoGrowInput()
function checkboxes(){$(".checkbox:not(.noiCheck)").iCheck({checkboxClass:"icheckbox_flat-grey",radioClass:"iradio_flat-grey",
//increaseArea: '20%',
ifChecked:function(){console.log($(this).next())}}),$(".checkbox:not(.noiCheck)").on("ifChecked",function(a){$(this).parent().next().addClass("checked")}).on("ifUnchecked",function(a){$(this).parent().next().removeClass("checked")})}function checkbox_resize(){$(window).width()>649&&$(window).width()<980&&($(".row-1").append($(".row-2").children()).removeClass("row-1").addClass("row-0"),$(".row-2").remove()),$(window).resize(function(){var a=$(window).width(),b=$(".size-param table"),c=$(".row-0"),d=$(".row-1"),e=$(".row-2");if(a>649&&a<980)c.length||(d.append(e.children()).removeClass("row-1").addClass("row-0"),e.remove());else if((a<650||a>779)&&c.length){var f=$("tr.row-0").children("td").slice(0,3),g=$("tr.row-0").children("td").slice(3,6);b.append($("<tr/>",{"class":"row-1",html:f})),b.append($("<tr/>",{"class":"row-2",html:g})),c.remove()}})}!function(a,b,c){"use strict";var d=a.jQuery||a.Zepto||a.$,e=function(a,c){this.el=this.isString(a)?b.querySelectorAll(a):a,this.options=c,this.prefix="fl-",this.init()};e.prototype={defaults:{customEvent:null,customLabel:null,exclude:".no-label",inputRegex:/email|number|password|search|tel|text|url/,prioritize:"label",// label|placeholder
...
B.length&&v&&d==s&&
// mouseout|touchend
B[/ut|nd/.test(c)?_remove:_add](w)),!_mobile)return!1;a.stopPropagation()}})})}}(window.jQuery||window.Zepto),$(document).ready(function(){$("form#nl_taper").floatlabels({style:1}),/* datepicker (pickadate)
    ---------------------------------------------------------------------------*/
date_picker(),mobile?($(".picker__frame").css({bottom:"0","margin-bottom":"0",top:"auto"}),$(".picker__box").css({"border-radius":"0","border-bottom-width":"0"})):$(".picker__frame").css({top:"15%"}),/*     if (mobile) {
...
$("input.autogrow").autoGrowInput({minWidth:30,comfortZone:20}),$(window).resize(function(){$("input.autogrow").autoGrowInput({minWidth:30,comfortZone:20})}),/*     if (mobile) {
        var deviceAgent = navigator.userAgent.toLowerCase();
        var iOS = deviceAgent.match(/(iPad|iPhone|iPod)/i);
        if (iOS) {
            console.log('iOS');
...
$(".date-wrapper").mouseover(function(){$(this).addClass("date-hover")}).mouseout(function(){$(this).removeClass("date-hover")}),/* checkboxes (iCheck)
    ---------------------------------------------------------------------------*/
checkboxes(),checkbox_resize()}),// datepicker()
$.fn.autoGrowInput=function(a){
//var options = {year: "numeric", month: "long", day: "numeric"};
//var date = new Date(),
//    longDate = date.toLocaleString('en-us', options);
//maxWidth: 1000,
if(mobile){var b=navigator.userAgent.toLowerCase(),c=b.match(/(iPad|iPhone|iPod)/i);if(c)if(console.log("iOS"),verge.viewportW()>verge.viewportH())var d="landscape";else var d="portrait"}
//o = $.extend({ maxWidth: 185, minWidth: 0, comfortZone: 70 }, o);
return console.log("orientation",d),"portrait"==d?(console.log("mobile portrait"),a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a)):a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a),this.filter("input:text").each(function(){var b=a.minWidth||$(this).width(),c="",d=$(this),e=$("<tester/>").attr("id","tester").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:d.css("fontSize"),fontFamily:d.css("fontFamily"),fontWeight:d.css("fontWeight"),letterSpacing:d.css("letterSpacing"),whiteSpace:"nowrap"}),f=function(){if(c!==(c=d.val())){
// Enter new content into testSubject
var f=c.replace(/&/g,"&amp;").replace(/\s/g," ").replace(/</g,"&lt;").replace(/>/g,"&gt;");e.html(f);
// Calculate new width + whether to change
//var testerWidth = testSubject.width();
var g=$("tester").width(),h=g+a.comfortZone>=b?g+a.comfortZone:b,i=d.width(),j=h<i&&h>=b||h>b&&h<a.maxWidth;
// Animate width
j&&(console.log("WIDTH CHANGED"),d.width(h)),console.log("viewportW()",verge.viewportW()),g===document.getElementById("tester").offsetWidth?console.log("testerWidth",g):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",g),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
//console.log('o.comfortZone', o.comfortZone);
//console.log('minWidth', minWidth);
console.log("testerWidth + o.comfortZone = newWidth",g+a.comfortZone),
//console.log('(testerWidth + o.comfortZone) >= minWidth', ((testerWidth + o.comfortZone) >= minWidth))
//console.log('newWidth', newWidth);
//console.log('o.maxWidth', o.maxWidth);
console.log("currentWidth",i),console.log("")}};if(e.insertAfter(d),
//$(this).bind('keyup keydown blur update', check);
//$(this).bind('keyup load blur update change', check).bind('keydown', function() {
//    setTimeout(check);
//});
$(this).bind("change",f),f(),$(window).load(f()),mobile){var g=navigator.userAgent.toLowerCase(),h=g.match(/(iPad|iPhone|iPod)/i);h&&(console.log("iOS"),$("#input_date").val())}}),this};