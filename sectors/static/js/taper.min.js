...
console.log("currentWidth",i),console.log(""),console.log("testSubject.width",e.width()),console.log("testSubject.fontSize",e.fontSize()),console.log("testSubject.fontFamily",e.fontFamily()),console.log("testSubject.fontWeight",e.fontWeight()),console.log("testSubject.letterSpacing",e.letterSpacing()),console.log("testSubject.whiteSpace",e.whiteSpace())}};if(e.insertAfter(d),
