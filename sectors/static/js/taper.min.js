...
// Animate width
if(k){var l=localStorage.getItem("initial_view");console.log("initial_view",l),l?(console.log("not first time here"),e.width(i)):(// never been here
console.log("first time here"),d?e.width(j-verge.viewportW()+a.comfortZone):e.width(i),localStorage.setItem("initial","1"))}console.log("viewportW()",verge.viewportW()),h===document.getElementById("tester").offsetWidth?console.log("testerWidth",h):(console.log("testerWidth != js testerWidth"),console.log("testerWidth",h),console.log('document.getElementById("tester").offsetWidth',document.getElementById("tester").offsetWidth)),
...
//    setTimeout(check);
//});
$(this).bind("change",g),g(),$(window).load(g())}),this};