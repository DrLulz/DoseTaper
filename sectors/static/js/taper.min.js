...
//maxWidth: 1000,
return a=$.extend({maxWidth:verge.viewportW(),minWidth:0,comfortZone:70},a),this.filter("input:text").each(function(){var b=a.minWidth||$(this).width(),c="",d=$(this),e=$("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:d.css("fontSize"),fontFamily:d.css("fontFamily"),fontWeight:d.css("fontWeight"),letterSpacing:d.css("letterSpacing"),whiteSpace:"nowrap"}),f=function(){if(c!==(c=d.val())){
// Enter new content into testSubject
var f=c.replace(/&/g,"&amp;").replace(/\s/g," ").replace(/</g,"&lt;").replace(/>/g,"&gt;");e.html(f);
// Calculate new width + whether to change
var g=e.width(),h=g+a.comfortZone>=b?g+a.comfortZone:b,i=d.width(),j=h<i&&h>=b||h>b&&h<a.maxWidth;
// Animate width
j&&d.width(h),
//console.log('viewportW()', verge.viewportW());
console.log("testerWidth",g),console.log("o.comfortZone",a.comfortZone),console.log("minWidth",b),console.log("testerWidth + o.comfortZone",g+a.comfortZone),console.log("(testerWidth + o.comfortZone) >= minWidth",g+a.comfortZone>=b),console.log("newWidth",h),
...
//    setTimeout(check);
//});
$(this).bind("change",f),f(),mobile){var g=navigator.userAgent.toLowerCase(),h=g.match(/(iPad|iPhone|iPod)/i);h&&(console.log("iOS"),$("tester").remove())}}),this};